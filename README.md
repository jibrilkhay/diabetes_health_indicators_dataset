...
2. **`diabetes_binary_5050split_health_indicators`** (70 692 lignes) : Binaire (0 = sain, 1 = prédiabétique/diabétique). **Parfaitement équilibré** (50/50).
3. **`diabetes_binary_health_indicators`** (253 680 lignes) : Binaire. Déséquilibré.
